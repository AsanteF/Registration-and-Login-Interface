...
<tr> 
<td><input type="text" name="name" value="<?php echo $_COOKIE["name"]; setcookie ("name", "", time() - 3600); ?>" id="name" placeholder="Enter your name                                                              *" required style="border:5px solid #7C70B8 ;">
</td> </tr>        
<tr> <td> <input type="email" name="email" value="<?php echo $_COOKIE["email"]; setcookie ("email", "", time() - 3600); ?>" required id="email" placeholder="Enter your email                                                              *" style="border:5px solid #7C70B8;"></td> </tr> 
...
<tr> <td> <input type="text" name="phone" id="phone" value="<?php echo $_COOKIE["phone"]; setcookie ("phone", "", time() - 3600); ?>" placeholder="Enter your phone number                                                 *" required style="border:5px solid #7C70B8;"></td> </tr> 
<tr> <td> <input type="password" name="pass" value="<?php echo $_COOKIE["pass"]; setcookie ("pass", "", time() - 3600); ?>" id="pass" placeholder="Create a password                                                          *" required style="border:5px solid #7C70B8;"></td> </tr> 
<tr>
